...
.sidebar {
  ...
  height: 100vh;
  width: 280px;
  background: linear-gradient(180deg, #FF6B6B 0%, #556270 100%);
  color: white;
  padding: 1.5rem;
...
<div class="sidebar">
  ...
  <ul class="nav flex-column">
    ...
    <li class="nav-item">
      <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'file_an_attendance.php' ? 'active' : ''; ?>" href="file_an_attendance.php">
        <i class="fas fa-clock"></i>
        Record Attendance
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'file_a_leave.php' ? 'active' : ''; ?>" href="file_a_leave.php">
